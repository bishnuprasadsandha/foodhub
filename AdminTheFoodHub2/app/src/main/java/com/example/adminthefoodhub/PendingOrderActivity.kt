...
import com.example.adminthefoodhub.databinding.ActivityPendingOrderBinding
...
class PendingOrderActivity : AppCompatActivity(), PendingOrderAdapter.OnItemClicked {
    ...
    private fun deleteThisItemFromOrderDetails(dispatchItemPushKey: kotlin.String) {
